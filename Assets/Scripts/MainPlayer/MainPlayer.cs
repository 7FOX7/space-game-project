...
public enum ShotType { REGULAR, THREE, LASER, CANNON, SCATTER, BOMB };
...
public class MainPlayer : InteractiveBody
{
    ...
    // MY CODE:
    [Tooltip("Game Object player fires.")]
    [SerializeField]
    private GameObject leftPlayerFire;
    [SerializeField]
    private GameObject rightPlayerFire; 
    [SerializeField]
    ...
    // variable to maintain if player has bomb:
    private bool hasBomb = false; 
	// store prefab for bomb: 
	[SerializeField]
    private GameObject bomb; 
    // create Mutator functions to handle the 'hasBomb':
    public bool GetBomb()
    {
        return hasBomb; 
    }
    ...
    /// <summary>
    /// Checks "Fire1" and "Fire2" input to fire shot. Also fires different shot types.
    /// </summary>
    private void CheckForFire()
    {
        ...
        // Drop bomb based on right click and condition: 
        else if(Input.GetButtonDown("Fire2") && GetBomb() == true)
        {
            DropBomb(); 
        }
    }
    ...
    // MY CODE: 
    /// <summary>
    /// Checks "Top Arrow" input to add effect of lighting fire
    /// </summary>
    ...
    private void CheckForMovement()
    {
        ...
        {
            //LeftFireOnMove(leftPlayerFire);
            //RightFireOnMove(rightPlayerFire); 
            leftPlayerFire.gameObject.SetActive(true);
            rightPlayerFire.gameObject.SetActive(true); 
        }
        else if(Input.GetKeyUp("up") || Input.GetKeyUp("right") || Input.GetKeyUp("left"))
        {
            leftPlayerFire.gameObject.SetActive(false); 
            rightPlayerFire.gameObject.SetActive(false);
        }
    }
